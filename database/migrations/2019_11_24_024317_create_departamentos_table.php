...
class CreateDepartamentosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Departamentos", 'departamentos', 'municipio', 'fa-cube', [
            ["municipio", "Municipio", "Dropdown", false, "", 0, 0, false, "@municipios"],
            ["nombreDepto", "Departamento", "String", false, "", 0, 256, true],
        ]);
