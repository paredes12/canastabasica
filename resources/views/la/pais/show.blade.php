...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Pais", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/pais/'.$pai->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Pais", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.pais.destroy', $pai->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/pais') }}" data-toggle="tooltip" data-placement="right" title="Back to Pais"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'nombrePais')
						@la_display($module, 'departamento')
						@la_display($module, 'canastabasicas')
