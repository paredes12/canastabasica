...
@section("contentheader_description", "Productos listing")
@section("section", "Productos")
@section("sub_section", "Listing")
@section("htmlheader_title", "Productos Listing")

@section("headerElems")
@la_access("Productos", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Producto</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Producto</h4>
			</div>
