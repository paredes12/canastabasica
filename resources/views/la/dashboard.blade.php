...
@section('contentheader_title') Generar Reporte @endsection
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3>Canasta <p><h3>Básica</h3></p></h3>
                  <p>Ver reporte Sondeo de Precios</p>
                </div>
                <div class="icon">
                  <i class="ion ion-bag"></i>
                </div>
                <a href="/reporte" class="small-box-footer">Clic para ver el reporte <i class="fa fa-arrow-circle-right"></i></a>
              </div>
