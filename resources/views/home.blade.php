...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-2">
                <h5>Integrantes</h5>
                <p>*González Murcia, Juan José</p>
                <p>*Hernández Vásquez, José Ernesto</p>
                <p>*Hernández Mendoza, Bryan Anthony</p>
                <p>*Ramos Ramos, Marvin</p>
                <p>*Paredes Pastran, Guillermo</p>
                <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/la-assets/img/arrow1.png') }}">
            </div>
            <div class="col-lg-8">
                <img class="img-responsive" src="{{ asset('/la-assets/img/Canasta-basica.jpg') }}" alt="">
            </div>
            <div class="col-lg-2">
                <br>
